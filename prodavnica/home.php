...
if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $val = true;
        ...
        if($val){
            ...
            $q="INSERT INTO `wishlist`( `user_id`, `product_id`, `name`, `cena`, `slika`) 
            VALUES ('$user_id','$pid','$name','$cena','$image')";
            $result = $conn->query($q);
            $greska = "added";}
        }
...
<form action="" method="POST" class="slide">
    ...
    <input type="submit" value="dodaj u wishlist" name="add_to_cart" class="btn"><span><?php echo $greska;?></span>
